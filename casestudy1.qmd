...
$$E[log(Buchanan2000)|log(Bush2000)] = \beta_0 + \beta_1*Bush2000 + \epsilon$$ $$= -2.5771236 +   0.7577224 *Bush2000 $$
...
election_transformed <- election |>
  mutate(`log(Buchanan2000)` = log(Buchanan2000),
    `log(Bush2000)` = log(Bush2000) )
