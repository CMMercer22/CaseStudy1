...
During the US presidential election of 2000 Palm Beach County used a new confusing ballot that could have potentially influenced the election results for this county. Amid the tight race between Gore and Bush, Palm Beach County had an unexpectedly high number of votes for Buchanan, from the Reform party. This may be due to the new ballot used in Palm Beach, where if not read closely, someone attempting to cast a vote for Gore could have mistakenly filled in the circle for Buchanan. 
In this case study, we plan to look at the relationship between Bush and Buchanan votes within Palm Beach County and compare that relationship to those in other Florida counties. We also plan to make a prediction of how many miscast votes there were.
