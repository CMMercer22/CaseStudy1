---
title: "How the Election of 2000 in Palm Beach County Was a Sham"
...
To begin we will assume conditions are met for linear regression model. Later we will asses the conditions.

```{r fig-pre-transformed, fig.cap=" "}
#NOTE TO US we should decide if we really want to use this graph. Is it necessary 
...
```{r}
#creating a linear model of the Buchannan and Bush Votes
