...
#AN EQUIVELENT OF THIS ALREADY EXISTS
...
#creating the prediction interval with a 95% conf level without specifying Palm Beach
prediction_interval1 <- election_lm_post |> augment(election, interval = "prediction", conf.level = 0.95)
