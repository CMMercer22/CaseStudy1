...
-   `Buchanan2000` : Number of votes for Buchanan in Palm Beach County during the 2000 election.
-   `Bush2000` : Number of votes for Bush in Palm Beach County during the 2000 election.
...
```
This summary of our linear model gives us a p-value of near 0. While this typically is an indicator of a strong linear relationship, because the conditions required for a linear model are violated it loses its meaning. We will expand on this below. 
...
#Creating a linear model of Buchanan votes and bush votes but they have both been log scaled.
...
#creating a residualplot of the transformed model 
